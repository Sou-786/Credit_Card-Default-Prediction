...
class CassandraDBOperations:
    def __init__(self):
        self.training_good_file_path = 'D:/CreditCardDefaulterPrediction/Training_ValidatedRawData/GoodDataFolder'
        ...
        cloud_config = {
            'secure_connect_bundle': 'D:/CreditCardDefaulterPrediction/CassandraConfigFiles/secure-connect-creditcarddefaulters.zip'
        }
    ...
    def selectingDatafromtableintocsv(self, table_name):
        try:
            ...
            i = 0
            path_to_final_csv = 'D:/CreditCardDefaulterPrediction/Training_InputFileFromDB/InputFile.csv'
